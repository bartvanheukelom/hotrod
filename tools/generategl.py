...
OUT_FILE_C = '../bin/gen/glconstants.js'
...
def main():
    ...
    for mode in ['f', 'c']:
        ...
        mdf = mode == 'f'
        print('=========== DOING THE ' + ("FUNCTIONS" if mdf else "CONSTANTS") + ' ============')

        with open(OUT_FILE if mdf else OUT_FILE_C, 'w') as fout:
            ...
            for json_in in sections:

                sec = json_in['section']
                if not (
                           sec.startswith('GL_VERSION_')
                        or sec.startswith('GL_ARB_')
                    ):
                    print("SKIP section " + sec)
                    continue
        ...
        print('=========== END OF THE ' + ("FUNCTIONS" if mdf else "CONSTANTS") + ' ============')
